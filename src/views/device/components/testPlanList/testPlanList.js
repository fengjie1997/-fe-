import {
  ...
  fetchtSchemaPortList
} from '@/api/device/testPlanList'

import { exportTxtToZip } from '@/vendor/Export2Txt'
// import { formatJson } from '@/utils/formatUtil'
import { TestPlanEditView } from '@/components/TestPlanTemplateForm'
...
export default {
  ...
  methods: {
    ...
    handleTestCreate() {
      ...
      fetchtSchemaPortList(this.deviceId).then(res => {
        console.log(res)
      })
      this.drawer = true
    },
