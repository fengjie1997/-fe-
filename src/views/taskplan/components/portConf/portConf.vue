<template>
  <el-row :gutter="10">
    <el-col style="display: flex; width: 320px;">
      <PortListView ref="portListView" :plan-id="planId" @setSchemaId="refreshSchemaId" />
    </el-col>
    <el-col style="display: flex; width: calc(100% - 320px)">
      ...
      <GroupLIstView
        ...
        @selectTaskGroup="handleSelectTaskGroup"
        @refreshTaskId="refreshTaskId"
        @editTaskFrom="handleEditTaskFrom"
        @addtask="addNewTask"
      />
      <el-dialog
        :title="$t('taskPlan.common.taskPlanConfig')"
      ...
      >
        ...
        <span slot="footer" class="dialog-footer">
          <el-button size="md" @click="dialogTaskForm = false, formReField()">{{ $t('common.cancel') }}</el-button>
          <el-button size="md" type="primary" @click="template = false, refTask(), formReField()">{{ $t('common.save') }}</el-button>
          <el-button size="md" type="primary" @click="template = true, refTask(), formReField()">{{ $t('taskPlan.label.saveTemplate') }}</el-button>
        </span>
      </el-dialog>
