<template>
  <el-collapse v-model="active" class="form-collapse">
    <el-collapse-item name="1">
      ...
      <el-form label-width="180px">
        <el-form-item label="多路上传配置：">
          <el-table :data="tableData" style="width: 90%" border>
            ...
            <el-table-column prop="localFile" label="本地文件" width="180" />
      ...
      <el-dialog title="添加多路上传配置" :visible.sync="dialogVisible" width="50%" class="conf-form-dialog" :append-to-body="true">
