<template>
  <el-form ref="dataForm" :model="model" :rules="rules" label-position="left" label-width="150px" style="width: 650px; margin-left:50px;">
    ...
    <el-form-item label="搜索地点" prop="searchPlace">
      <el-input v-model="model.searchPlace" :disabled="state" />
    </el-form-item>
  </el-form>
</template>
...
import {
  ...
  testIntervalsCheck,
  testTimesCheck,
  tencentNewsTimeoutCheck, searchPlaceCheck
  ...
  data() {
    return {
      ...
      rules: {
        ...
        searchPlace: [{
          validator: searchPlaceCheck, // 自定义验证
          trigger: 'blur'
        }]
      },
      temp: {
