<template>
  <div>
    ...
    >
      ...
      <el-table-column :label="$t('common.actions')" align="center" width="200" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          ...
          <el-button size="mini" @click="handleExportConfig(scope.row)">{{ $t('common.export') }}</el-button>
    ...
    <div>
      ...
      >
        <span>{{ $t('taskPlan.common.exportXml') }}</span>
        <el-input
    ...
    <div>
      ...
      <el-drawer
        ...
        size="80%"
      >
        <div slot="title" style="vertical-align:middle;">
          <img :src="require('@/assets/logo/logo.png')" width="36px" style="margin-right: 5px;padding-top:5px">
          <span style="font-size: 1.5em;">
            {{ $t('testPlan.testPlan') }}: 我是测试计划名称
          </span>
