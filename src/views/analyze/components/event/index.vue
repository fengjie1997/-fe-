<template>
  <div class="grid-form tag-page-container">
    <!-- 项目弹框 -->
    ...
    <el-form ref="searchForm" :model="form" label-width="110px">
      <el-row>
        ...
        >
          <el-select v-model="Name" clearable :placeholder="$t('analyze.placeholder.select')" class="grid-form-field" @change="handleOperatorClear">
            <el-option
        ...
        >
          <el-select v-model="operatorId" clearable :placeholder="$t('analyze.placeholder.select')" class="grid-form-field" @change="handleEventOption">
            <el-option
        ...
        <el-form-item
          :label="$t('analyze.label.event')"
          class="grid-form-item"
          :rules="[
            { required: true, message: $t('analyze.label.event'), trigger: 'blur' },
          ]"
        >
          <el-select v-model="code" :placeholder="$t('analyze.placeholder.select')" class="grid-form-field" @change="handleEventAdd">
            <el-option v-for="(item,index) in eventOptions" :key="index" :label="item.name" :value="item.code" />
          </el-select>
        </el-form-item>
        <template>
          <el-table
          ...
          >
            <el-table-column
              :label="$t('analyze.label.eventList')"
              prop="name"
            />
      ...
      <el-row class="grid-row">
        ...
        >
          <el-input v-model="programName" :placeholder="$t('analyze.placeholder.select')" readonly class="input-with-select">
            <el-button slot="append" icon="el-icon-plus" @click="showWindow = true" />
          </el-input>
        </el-form-item>
      </el-row>
      <el-row class="grid-row">
      ...
      <el-row class="grid-row">
        ...
        >
          <el-input v-model="areaName" :placeholder="$t('analyze.placeholder.select')" readonly class="input-with-select">
            <el-button slot="append" icon="el-icon-plus" @click="showWindowArea = true" />
          </el-input>
        </el-form-item>
      </el-row>
      <el-row class="grid-row">
        ...
        <el-form-item :label="$t('analyze.label.testBusiness')" class="grid-form-item">
          <el-select v-model="fileType" :placeholder="$t('analyze.placeholder.select')" multiple class="grid-form-field">
            <el-option v-for="(item,index) in taskTypes" :key="index" :label="item.name" :value="item.code" />
          </el-select>
        </el-form-item>
